...
GO
PRINT N'Rename refactoring operation with key f0ee11b4-5cc4-4c9e-aa08-cab2213b8b2a is skipped, element [dbo].[Dim_Categoria].[Id] (SqlSimpleColumn) will not be renamed to Cod_Categoria';


GO
PRINT N'Rename refactoring operation with key fc874dc8-ce87-44ae-b4e7-5683c223eca1 is skipped, element [dbo].[Dim_Marca].[Id] (SqlSimpleColumn) will not be renamed to Cod_Marca';


GO
PRINT N'Rename refactoring operation with key 052d57bc-13a6-437c-9bfc-76e22e914d79 is skipped, element [dbo].[Dim_Produto].[Id] (SqlSimpleColumn) will not be renamed to Cod_Produto';
